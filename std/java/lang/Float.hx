...
@:forward abstract Float(FloatClass) from FloatClass to FloatClass
{
	...
	@:from @:extern inline public static function fromFloat(b:std.StdTypes.Float):Float
...
@:native("java.lang.Float") extern class FloatClass extends Number implements Comparable<Float>
{
	...
	@:overload function compareTo(param1 : std.StdTypes.Float) : Int;
	...
	@:overload @:throws("java.lang.NumberFormatException") static function valueOf(param1 : String) : std.StdTypes.Float;
	@:overload static function valueOf(param1 : Single) : std.StdTypes.Float;
